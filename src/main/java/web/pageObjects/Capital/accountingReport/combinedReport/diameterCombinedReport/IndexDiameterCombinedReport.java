package web.pageObjects.Capital.accountingReport.combinedReport.diameterCombinedReport;
 ...
 * 元素定位
 */
public class IndexDiameterCombinedReport {
    //搜索条件
    ...
    public static By view = By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='重置搜索条件'])[1]/following::button[1]");//查看明细数据
